...
type CallMethod = "KVS.Set" | "KVS.Get" | "Script.Start" | "Script.Stop" | "HTTP.Request";
...
declare const Shelly: {
     ...
     */
    addEventHandler(callback: (event_data: EventData, userdata: any) => void, userdata: any): subscription_handle
    /**
     ...
     */
    addStatusHandler(callback: (event_data: EventData, userdata: any) => void, userdata: any): subscription_handle
